...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('css/templatemo-topic-listing.css')); ?>">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <div className="d-none d-lg-block">
                            <a href="/login" class="btn btn-light text-primary fw-semibold">Login</a>
                        </div>
                    </div>
                </div>
            </nav>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <p class="mb-0 fw-normal"><?php echo e($item->tanggal); ?></p>
                                                </td>
                                                <td class="border-bottom-0">
                                                    <h6 class="fw-semibold mb-1"><?php echo e($item->konsumen->name); ?></h6>
                                                </td>
                                                <td class="border-bottom-0">
                                                    <h6 class="fw-semibold mb-1"><?php echo e($item->jenis_layanan->name); ?></h6>
                                                </td>
                                                <td class="border-bottom-0">
                                                    <h6 class="fw-semibold mb-1"><?php echo e($item->total_berat); ?></h6>
                                                </td>
                                                <td class="border-bottom-0">
                                                    <h6 class="fw-semibold mb-1"><?php echo e($item->jenis_pembayaran->name); ?></h6>
                                                </td>
                                                <td class="border-bottom-0">
                                                    <h6 class="fw-semibold mb-1"><?php echo e($item->total_harga); ?></h6>
                                                </td>
                                                <td class="border-bottom-0">
...
<?php /**PATH C:\laravel\ujikom-bersama\resources\views/welcome.blade.php ENDPATH**/ ?>